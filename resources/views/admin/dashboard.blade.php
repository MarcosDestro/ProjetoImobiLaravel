                    ...
                    <tbody>
                        @foreach ($contracts as $contract)
                            <tr>
                                ...
                                <td><a href="{{ route('admin.users.edit', ['user' =>$contract->owner]) }}" class="text-orange">{{ $contract->ownerRelation->name }}</a></td>
                                <td><a href="{{ route('admin.users.edit', ['user' =>$contract->acquirer]) }}" class="text-orange">{{ $contract->acquirerRelation->name }}</a></td>
