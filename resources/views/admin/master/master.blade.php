...
@php
    // Se for diferente de vazio e existir o arquivo...
...
<div class="dash">
    <aside class="dash_sidebar">
        ...
        <ul class="dash_sidebar_nav">
            ...
            <li class="dash_sidebar_nav_item"><a class="icon-users {{ isActive('admin.users') }} {{ isActive('admin.companies') }}" href="{{ route('admin.users.index') }}">Clientes</a>
            ...
            <li class="dash_sidebar_nav_item"><a class="icon-home" href="{{ route('admin.properties.index') }}">Imóveis</a>
                <ul class="dash_sidebar_nav_submenu {{ isActive('admin.properties') }}">
