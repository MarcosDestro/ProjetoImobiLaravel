                ...
                <div class="nav_tabs_content">
                    <div id="data">
                        <div class="label_gc">
                            ...
                            <label class="label">
                                <input type="checkbox" name="lessor" {{ (old('lessor') == true || old('lessor') == 'on' ? 'checked' : '') }}><span>Locatário</span>
                            </label>

                            <label class="label">
                                <input type="checkbox" name="lessee" {{ (old('lessee') == true || old('lessee') == 'on' ? 'checked' : '') }}><span>Locador</span>
                            </label>
                        </div>
                    ...
                    <div id="management" class="d-none">
                        <div class="label_gc">
                            ...
                            <label class="label">
                                <input type="checkbox" name="admin" {{ (old('admin') == true || old('admin') == 'on' ? 'checked' : '') }}><span>Administrativo</span>
                            </label>

                            <label class="label">
                                <input type="checkbox" name="client" {{ (old('client') == true || old('client') == 'on' ? 'checked' : '') }}><span>Cliente</span>
                            </label>
                        </div>
                    </div>
                </div>
