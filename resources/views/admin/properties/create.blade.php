                ...
                <div class="nav_tabs_content">
                    <div id="data">
                        <div class="label_gc">
                            ...
                            <label class="label">
                                <input type="checkbox" name="sale" {{ (old('sale') == 'on' || old('sale') == 'on' ? 'checked' : '') }}><span>Venda</span>
                            </label>

                            <label class="label">
                                <input type="checkbox" name="rent" {{ (old('rent') == 'on' || old('rent') == 'on' ? 'checked' : '') }}><span>Locação</span>
                            </label>
                        </div>
                    ...
                    <div id="structure" class="d-none">
                        ...
                        <div class="label_g5">
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="air_conditioning" {{ (old('air_conditioning') == 'on' || old('air_conditioning') == 'on' ? 'checked' : '') }}><span>Ar Condicionado</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="bar" {{ (old('bar') == 'on' || old('bar') == 'on' ? 'checked' : '') }}><span>Bar</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="library" {{ (old('library') == 'on' || old('library') == 'on' ? 'checked' : '') }}><span>Biblioteca</span>
                                </label>
                            </div>

                            <div>
                                <label class="label">
                                    <input type="checkbox" name="barbecue_grill" {{ (old('barbecue_grill') == 'on' || old('barbecue_grill') == 'on' ? 'checked' : '') }}><span>Churrasqueira</span>
                                </label>
                            </div>

                            <div>
                                <label class="label">
                                    <input type="checkbox" name="american_kitchen" {{ (old('american_kitchen') == 'on' || old('american_kitchen') == 'on' ? 'checked' : '') }}><span>Cozinha Americana</span>
                                </label>
                            </div>

                            <div>
                                <label class="label">
                                    <input type="checkbox" name="fitted_kitchen" {{ (old('fitted_kitchen') == 'on' || old('fitted_kitchen') == 'on' ? 'checked' : '') }}><span>Cozinha Planejada</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="pantry" {{ (old('pantry') == 'on' || old('pantry') == 'on' ? 'checked' : '') }}><span>Despensa</span>
                                </label>
                            </div>

                            <div>
                                <label class="label">
                                    <input type="checkbox" name="edicule" {{ (old('edicule') == 'on' || old('edicule') == 'on' ? 'checked' : '') }}><span>Edícula</span>
                                </label>
                            </div>

                            <div>
                                <label class="label">
                                    <input type="checkbox" name="office" {{ (old('office') == 'on' || old('office') == 'on' ? 'checked' : '') }}><span>Escritório</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="bathtub" {{ (old('bathtub') == 'on' || old('bathtub') == 'on' ? 'checked' : '') }}><span>Banheira</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="fireplace" {{ (old('fireplace') == 'on' || old('fireplace') == 'on' ? 'checked' : '') }}><span>Lareira</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="lavatory" {{ (old('lavatory') == 'on' || old('lavatory') == 'on' ? 'checked' : '') }}><span>Lavabo</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="furnished" {{ (old('furnished') == 'on' || old('furnished') == 'on' ? 'checked' : '') }}><span>Mobiliado</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="pool" {{ (old('pool') == 'on' || old('pool') == 'on' ? 'checked' : '') }}><span>Piscina</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="steam_room" {{ (old('steam_room') == 'on' || old('steam_room') == 'on' ? 'checked' : '') }}><span>Sauna</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="view_of_the_sea" {{ (old('view_of_the_sea') == 'on' || old('view_of_the_sea') == 'on' ? 'checked' : '') }}><span>Vista para o Mar</span>
                                </label>
                            </div>
                        </div>
