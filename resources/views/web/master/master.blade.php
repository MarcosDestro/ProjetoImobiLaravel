...
<head>
    ...
    <link rel="stylesheet" href="{{ url(mix('frontend/assets/css/app.css')) }}">
...
<script src="{{ url(mix('frontend/assets/js/jquery.js')) }}"></script>
<script src="{{ url(mix('frontend/assets/js/bootstrap.js')) }}"></script>
<script src="{{ url(mix('frontend/assets/js/libs.js')) }}"></script>
<script src="{{ url(mix('frontend/assets/libs/libs.js')) }}"></script>
<script src="{{ url(mix('frontend/assets/js/scripts.js')) }}"></script>
