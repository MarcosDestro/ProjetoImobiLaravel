            ...
            <div class="row text-left">
                <form action="{{ route('web.sendEmail') }}" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Insira seu nome">
                    </div>

                    <div class="form-group">
                        <input type="email" name="email" class="form-control" value="{{ old('email') }}" placeholder="Insira seu melhor e-mail">
                    </div>

                    <div class="form-group">
                        <input type="tel" name="cell" class="form-control" value="{{ old('cell') }}" placeholder="Insira seu telefone">
                    </div>
